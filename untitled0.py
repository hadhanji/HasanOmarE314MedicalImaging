if __name__ == '__main__':
    ...
    import os
    for dirname, _, filenames in os.walk('C:ECEN314FinalProject/'):
    ...
    def plot_accuracies(history):
        ...
        plt.savefig("C:/FinalProjectPlots/accuracyVsNumEpochsOrig.jpg")
        plt.clf()
    ...
    def plot_losses(history):
        ...
        plt.savefig("C:/FinalProjectPlots/lossesOrig.jpg")
